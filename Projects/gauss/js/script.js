...
jQuery(window).load(function() { 
		...
		$('.teaserTitle ').stop().animate({marginTop :'120px', opacity:"1"}, 1000, 'easeOutQuint');
...
$("#mainNav ul a, .logo a, .shortcat a, .notBtn a").click(function(e){
...
$(".testimoniaContainer").parallax("300%", 0.3);
$("#teaser").parallax("10%", 0.3);
...
//---------------------------------- Fixing flexslider nav in safari -----------------------------------------//

$.browser.chrome = /chrome/.test(navigator.userAgent.toLowerCase());
$.browser.safari = /safari/.test(navigator.userAgent.toLowerCase());

   if ($.browser.safari && !$.browser.chrome) {
        $('.flex-control-paging li a.flex-active').css('top', '-2px');
...
//---------------------------------- End Fixing flexslider nav in safari -----------------------------------------//
